...
AZURE_SEARCH_SERVICE = os.environ.get("AZURE_SEARCH_SERVICE", "cog-fema-bud")
AZURE_SEARCH_INDEX = os.environ.get("AZURE_SEARCH_INDEX","indx-fema-bud")
AZURE_SEARCH_KEY = os.environ.get("AZURE_SEARCH_KEY","Lvb7iji0WQFT7JkaXOzwZaxV204kGi3eVl85yiFYmsAzSeB1b8It")
...
AZURE_OPENAI_RESOURCE = os.environ.get("AZURE_OPENAI_RESOURCE", "Lvb7iji0WQFT7JkaXOzwZaxV204kGi3eVl85yiFYmsAzSeB1b8It")
AZURE_OPENAI_MODEL = os.environ.get("AZURE_OPENAI_MODEL","gpt-35-turbo-16k")
AZURE_OPENAI_KEY = os.environ.get("AZURE_OPENAI_KEY","977a35ba151d4cf0b7c19d7fa92e2e5d")
AZURE_OPENAI_TEMPERATURE = os.environ.get("AZURE_OPENAI_TEMPERATURE", .1)
AZURE_OPENAI_TOP_P = os.environ.get("AZURE_OPENAI_TOP_P", 1.0)
AZURE_OPENAI_MAX_TOKENS = os.environ.get("AZURE_OPENAI_MAX_TOKENS", 7000)
AZURE_OPENAI_STOP_SEQUENCE = os.environ.get("AZURE_OPENAI_STOP_SEQUENCE")
AZURE_OPENAI_SYSTEM_MESSAGE = os.environ.get("AZURE_OPENAI_SYSTEM_MESSAGE", "You are an expert in all things related to FEMA Budget.  You are always very polite and go out of your way to answer questions.  Always confirm answers and ask if there are other ways you can be of assistance.  Always remind the user that FEMA has the best mission – help people before, during, and after disasters.  Keep in mind money is needed to help people and we receive money from through the budget process.  If asked a question in another language, please respond in the requested language.")
